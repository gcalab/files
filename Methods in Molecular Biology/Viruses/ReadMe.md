...
7. This is how the RMSD header file looks like, you will need to parse it line by line or use one of the scripts in this repo to extract position wise RMSD values. <img src="img/chimera_hdr.png" alt="Window open after selecting to save RMSD headers giving option of file name and location" style="width:50%; height:auto;">

/*****************************************************************************
 *                                                                           *
 *  This file contains the class declaration for the organism class.         *
 *                                                                           *
 *                                                                STOAT 2007 *
 *****************************************************************************/
...
public:
    ...
    std::string helix_num_dcse;   // The Helix numbering string for the DCSE format

    std::string parenthesis_user; // The secondary structure format provided by the user.

    // Statistical properties.
    int np;            // Number of paired nucleotides in secondary structure.
